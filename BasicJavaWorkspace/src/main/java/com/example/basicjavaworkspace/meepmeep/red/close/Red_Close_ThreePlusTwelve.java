...
public class Red_Close_ThreePlusTwelve {
    ...
    public static void main(String[] args) {
        ...
        path1 = myBot.getDrive().actionBuilder(
                ...
                .splineToConstantHeading(new Vector2d(LEFT_COLLECT_POSE_X, NORTH_COLLECT_POSE_Y-20), new Rotation2d(0,0))
                .splineToConstantHeading(new Vector2d(LEFT_COLLECT_POSE_X, NORTH_COLLECT_POSE_Y), NORTH_HEADING)
...
//        ;
        ...
        TrajectoryActionBuilder path3 = myBot.getDrive().actionBuilder(
                        new Pose2d(LEFT_COLLECT_POSE_X, NORTH_COLLECT_POSE_Y, NORTH_HEADING))
                .splineToConstantHeading(
                        new Vector2d(GATE_POSE_X, NORTH_COLLECT_POSE_Y),
                        new Rotation2d(-3, 8)
                )
        ...
        TrajectoryActionBuilder path4 = myBot.getDrive().actionBuilder(
                ...
                .splineToLinearHeading(
                        new Pose2d(MID_COLLECT_POSE_X, NORTH_COLLECT_POSE_Y, NORTH_HEADING),
                        new Rotation2d(0, 4)
                )
