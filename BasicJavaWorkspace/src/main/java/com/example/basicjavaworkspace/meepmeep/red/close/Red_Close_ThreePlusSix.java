...
public class Red_Close_ThreePlusSix {
    ...
    public static double SHOOT_HEADING = Math.toRadians(127);
    ...
    public static void main(String[] args) {
        ...
        TrajectoryActionBuilder path2 = myBot.getDrive().actionBuilder(new Pose2d(SHOOT_POSE_X, SHOOT_POSE_Y, SHOOT_HEADING))
                .strafeToLinearHeading(new Vector2d(LEFT_COLLECT_POSE_X, SOUTH_READY_POSE_Y), NORTH_HEADING);
        TrajectoryActionBuilder path3 = myBot.getDrive().actionBuilder(new Pose2d(LEFT_COLLECT_POSE_X, SOUTH_READY_POSE_Y, NORTH_HEADING))
                .strafeToLinearHeading(new Vector2d(LEFT_COLLECT_POSE_X, SOUTH_COLLECT_POSE_Y), NORTH_HEADING);
        TrajectoryActionBuilder path4 = myBot.getDrive().actionBuilder(new Pose2d(LEFT_COLLECT_POSE_X,SOUTH_COLLECT_POSE_Y,NORTH_HEADING))
        ...
        TrajectoryActionBuilder path5 = myBot.getDrive().actionBuilder(new Pose2d(SHOOT_POSE_X, SHOOT_POSE_Y, SHOOT_HEADING))
                .strafeToLinearHeading(new Vector2d(MID_COLLECT_POSE_X, SOUTH_READY_POSE_Y), NORTH_HEADING);
        TrajectoryActionBuilder path6 = myBot.getDrive().actionBuilder(new Pose2d(MID_COLLECT_POSE_X, SOUTH_READY_POSE_Y, NORTH_HEADING))
                .strafeToLinearHeading(new Vector2d(MID_COLLECT_POSE_X, SOUTH_COLLECT_POSE_Y), NORTH_HEADING);
        TrajectoryActionBuilder path7 = myBot.getDrive().actionBuilder(new Pose2d(MID_COLLECT_POSE_X,SOUTH_COLLECT_POSE_Y,NORTH_HEADING))
                .strafeToLinearHeading(new Vector2d(SHOOT_POSE_X, SHOOT_POSE_Y), SHOOT_HEADING, new TranslationalVelConstraint(25) );
