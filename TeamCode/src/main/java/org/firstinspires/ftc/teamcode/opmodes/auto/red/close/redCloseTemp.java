...
//    public static final Pose2d lastShootPose = new Pose2d(-40, 10, Math.toRadians(360 - 240));
//
//
...
//    public static TrajectoryActionBuilder goShootLastFixed;
//
...
//                .setTangent(new Rotation2d(2,-4.0))
...
//
//        goShootLastFixed = drive.actionBuilder(rightCollectPose)
//                .splineToLinearHeading(lastShootPose, new Rotation2d(-1,1), fastToShoot);
//    }
//}