...
public class Blue_Close_ThreePlusThree extends CommandOpMode {
    ...
    public static final double OBELISK_POSE_X = -51.9;
    public static final double OBELISK_POSE_Y = -24;
    public static final double OBELISK_HEADING = Math.toRadians(180);
