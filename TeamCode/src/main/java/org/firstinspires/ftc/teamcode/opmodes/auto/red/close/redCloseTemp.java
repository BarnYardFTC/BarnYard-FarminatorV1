...
public class redCloseTemp {
    ...
    public static final Pose2d startPose = new Pose2d( -53.333, 45.5, Math.toRadians(135));
    public static final Pose2d shootPose = new Pose2d(-23, 22, Math.toRadians(137));
    public static final Pose2d lastShootPose = new Pose2d(-40, -22, Math.toRadians(151));


    public static final Pose2d leftCollectPose = new Pose2d(-11.5, 63, Math.toRadians(90));
    public static final Pose2d midCollectPose = new Pose2d(12, 63, Math.toRadians(90));
    public static final Pose2d rightCollectPose = new Pose2d(34.5, 63, Math.toRadians(90));

    public static final Pose2d leftCollectReady = new Pose2d(-11.5, -20, Math.toRadians(90));
    public static final Pose2d midCollectReady = new Pose2d(34.5, -20, Math.toRadians(90));
    public static final Pose2d rightCollectReady = new Pose2d(12, -20, Math.toRadians(90));

    public static final Pose2d parkPose = new Pose2d(-40, -22, Math.toRadians(180));
    public static final Pose2d gateOpenPose = new Pose2d(0, -50, Math.toRadians(90));
    public static final Pose2d gateCollectPose = new Pose2d(10,-57, Math.toRadians(137));
