...
public class redFarTemp { public static final int SHOOT_TIME_MS = 1500;

    public static final Pose2d startPose = new Pose2d(60, 15, Math.toRadians(180));
    public static final Pose2d shootPose = new Pose2d(23.0, 22, Math.toRadians(147.0));
    public static final Pose2d lastShootPose = new Pose2d(40.0, 22, Math.toRadians(161.0));
    ...
    public static final Pose2d gateOpenPose = new Pose2d(-0.0, 50, Math.toRadians(270.0));
