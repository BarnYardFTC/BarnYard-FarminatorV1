...
public class BlinkinLED extends SubsystemBase {
    ...
    public void periodic() {
        if (BarnRobot.getInstance().colorSensor.isOnlyShootPosBusy()) setRed();
        else if (BarnRobot.getInstance().colorSensor.isOnlyShootAndMidBusy()) setPurple();
        else if (BarnRobot.getInstance().colorSensor.isRobotFull()) setGreen();
        else setBlack();
    }
