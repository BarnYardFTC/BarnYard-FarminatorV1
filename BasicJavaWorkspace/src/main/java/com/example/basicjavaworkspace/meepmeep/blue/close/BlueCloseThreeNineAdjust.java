...
public class BlueCloseThreeNineAdjust {
    ...
    public static void main(String[] args) {
        ...
        TrajectoryActionBuilder path2 = myBot.getDrive().actionBuilder(leftCollectPose)
        ...
        TrajectoryActionBuilder path5 = myBot.getDrive().actionBuilder(midShootPose)
