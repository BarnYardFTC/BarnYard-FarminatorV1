...
public class Blue_Close_ThreePlusFifteen {
    ...
    public static double SHOOT_HEADING = Math.toRadians(229);
    public static double GATE_HEADING = Math.toRadians(227);
    ...
    public static double GATE_POSE_Y = -54;
    ...
    public static void main(String[] args) {
        ...
        path1 = myBot.getDrive().actionBuilder(
                ...
                .splineToConstantHeading(new Vector2d(MID_COLLECT_POSE_X, SOUTH_COLLECT_POSE_Y+2), new Rotation2d(0,-2))
        ...
        TrajectoryActionBuilder path2 = myBot.getDrive().actionBuilder(
                ...
                .splineToLinearHeading(new Pose2d(GATE_POSE_X+5,GATE_POSE_Y, GATE_HEADING), new Rotation2d(0,-4), new TranslationalVelConstraint(100));

        TrajectoryActionBuilder path5 = myBot.getDrive().actionBuilder(new Pose2d(GATE_POSE_X+5,GATE_POSE_Y, GATE_HEADING))
                .strafeToConstantHeading(new Vector2d(GATE_POSE_X+7, GATE_POSE_Y-2))
                .splineToSplineHeading(new Pose2d(SHOOT_POSE_X,SHOOT_POSE_Y,SHOOT_HEADING),new Rotation2d(-2,-2), new TranslationalVelConstraint(150));
